...
- **Mathematical Constraints:** Loss functions must be continuous and smooth to allow [[Derivative|gradient]] computation. Evaluation metrics (like Accuracy or F1-Score) can be non-differentiable or discontinuous.
...
## Non-Differentiable Metrics Optimization

Event though a certain [[Machine Learning Concepts|Machine Learning]] models are evaluated using non-differentiable metrics, the model itself is optimized using a [[Derivative|differentiable]] surrogate. 